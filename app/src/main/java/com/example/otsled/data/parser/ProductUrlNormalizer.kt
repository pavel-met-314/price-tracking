...
object ProductUrlNormalizer {
    ...
    private val URL_IN_TEXT_REGEX = Regex("""(?iu)https?://\S+""", RegexOption.IGNORE_CASE)
    private val HOST_IN_TEXT_REGEX = Regex("""(?iu)(?:www\.)?allureparfum\.ru\S*""", RegexOption.IGNORE_CASE)
